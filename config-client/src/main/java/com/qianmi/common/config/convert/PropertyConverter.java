package com.qianmi.common.config.convert;
...
public final class PropertyConverter
{
     ...
     * @throws ClassCastException if the value is not compatible with the requested type
     *
     * @since 1.5
     */
    static Object to(Class<?> cls, Object value, Object... params) throws ClassCastException
    {
        ...
        throw new ClassCastException("The value '" + value + "' (" + value.getClass() + ")"
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a boolean
     */
    public static Boolean toBoolean(Object value) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            if (b == null)
            {
                throw new ClassCastException("The value " + value + " can't be converted to a Boolean object");
            }
            return b;
        }
        else
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a byte
     */
    public static Byte toByte(Object value) throws ClassCastException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a short
     */
    public static Short toShort(Object value) throws ClassCastException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to an integer
     */
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a Long
     */
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a Float
     */
    public static Float toFloat(Object value) throws ClassCastException
    {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a Double
     */
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a BigInteger
     */
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a BigDecimal
     */
     ...
     * @throws ClassCastException if the object cannot be converted
     */
    static Number toNumber(Object value, Class<?> targetClass) throws ClassCastException
    {
        ...
        else
        {
            ...
            if (str.startsWith(HEX_PREFIX))
            {
                ...
                {
                    throw new ClassCastException("Could not convert " + str
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to an URL
     */
    public static URL toURL(Object value) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to an URL");
            }
        }
        else
        {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a Locale
     */
    public static Locale toLocale(Object value) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to a Locale");
            }
        }
        else
        {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a Color
     */
    public static Color toColor(Object value) throws ClassCastException
    {
        ...
        else if (value instanceof String && !StringUtils.isBlank((String) value))
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to a Color");
            }
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to a InetAddress
     *
     * @since 1.5
     */
    static InetAddress toInetAddress(Object value) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to a InetAddress");
            }
        }
        else
        {
     ...
     * @param value the value to convert
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to an email address
     *
     * @since 1.5
     */
    static Object toInternetAddress(Object value) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to a InternetAddress");
            }
        }
        else
        {
     ...
     * @return the converted value
     * @throws ClassCastException thrown if the value cannot be converted to an enumeration
     *
     * @since 1.5
     */
    static <E extends Enum<E>> E toEnum(Object value, Class<E> cls) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to a " + cls.getName());
            }
        }
     ...
     */
    public static Date toDate(Object value, String format) throws ClassCastException
    {
     ...
     * @throws ClassCastException thrown if the value cannot be converted to a Calendar
     */
    public static Calendar toCalendar(Object value, String format) throws ClassCastException
    {
        ...
        else if (value instanceof String)
        {
            ...
            {
                throw new ClassCastException("The value " + value + " can't be converted to a Calendar");
            }
        }
        else
        {
