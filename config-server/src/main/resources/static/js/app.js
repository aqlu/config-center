...
var CodeMirror = (function () {
    function v(aN, aK) {
        ...
        var bY = aE.firstChild, bn = bY.firstChild, bl = aE.lastChild, bN = bl.firstChild, ch = bN.firstChild, aI = ch.firstChild, aZ = aI.firstChild, bv = aI.nextSibling.firstChild, aw = bv.firstChild, bd = aw.nextSibling, bh = bd.nextSibling, ar = bh.nextSibling;
        cE();
        if (t) {
            bn.style.width = "0px"
        }
        ...
        var b8 = new A(), ax = new A(), cQ;
        var cc, cz = new i([new ai([new e("")])]), ci, ck;
        bU();
        var cX = {from: {line: 0, ch: 0}, to: {line: 0, ch: 0}, inverted: false};
        var cj, br, a0, bG = 0, bc, co = false, ct = false;
        var cq, b7, aC, cO, aQ, bg, aT, cB;
        var be = 0, cR = 0, bM = 0, bO = 0;
        var b5;
        var bE = "", aG;
        var aq = {};
        at(function () {
        ...
        var ca = aE.CodeMirror = {
            ...
            historySize: function () {
                return {undo: a9.done.length, redo: a9.undone.length}
            },
            ...
            addWidget: function (c4, c2, c6, c3, c8) {
                ...
                if (c3 == "over") {
                    ...
                    if (c3 == "near") {
                        var c0 = Math.max(bl.offsetHeight, cz.height * bQ()), c7 = Math.max(bN.clientWidth, bv.clientWidth) - a6();
            ...
            setLine: at(function (c0, c1) {
                if (bs(c0)) {
                    bR(c1, {line: c0, ch: 0}, {line: c0, ch: cG(c0).text.length})
                }
            }),
            removeLine: at(function (c0) {
                if (bs(c0)) {
                    bR("", {line: c0, ch: 0}, aU({line: c0 + 1, ch: 0}))
                }
            }),
            replaceRange: at(bR),
        ...
        function aX(c0) {
            var c1 = {line: 0, ch: 0};
            aP(c1, {line: cz.size - 1, ch: cG(cz.size - 1).text.length}, B(c0), c1, c1);
            cq = true
        }
        ...
        function ao(c4) {
            ...
            c4.preventDefault();
            var c7 = a3(c4, true), c1 = c4.dataTransfer.files;
            if (!c7 || b2.readOnly) {
                return
            }
            if (c1 && c1.length && window.FileReader && window.File) {
                ...
                var c6 = c1.length, c5 = Array(c6), c2 = 0;
        ...
        function cM(c6) {
            ...
            var c1 = S[z(c6, "keyCode")], c5 = false;
        ...
        function bo(c3) {
            ...
            var c2 = z(c3, "keyCode"), c0 = z(c3, "charCode");
        ...
        function cb(c5, c6) {
            ...
            for (var c2 = c7.length - 1; c2 >= 0; c2 -= 1) {
                var c4 = c7[c2];
                var c8 = [], c0 = c4.start + c4.added;
                cz.iter(c4.start, c0, function (c9) {
                    c8.push(c9.text)
                });
                c1.push({start: c4.start, added: c4.old.length, old: c8});
                var c3 = aU({line: c4.start + c4.old.length - 1, ch: X(c8[c8.length - 1], c4.old[c4.old.length - 1])});
                au({line: c4.start, ch: 0}, {line: c0 - 1, ch: cG(c0 - 1).text.length}, c4.old, c3, c3)
            }
            cq = true;
            c6.push(c1)
        }
        ...
        function au(df, c4, dl, c0, dm) {
            ...
            var dc = c4.line - df.line, db = cG(df.line), c1 = cG(c4.line);
            ...
            ci = c2;
            bH(100);
            aC.push({from: df.line, to: c4.line + 1, diff: c8});
            var c7 = {from: df, to: c4, text: dl};
            if (cO) {
        ...
        function bR(c1, c4, c3) {
            ...
            function c2(c7) {
                ...
                return {line: c5, ch: c6}
            }

            var c0;
            aD(c1, c4, c3, function (c5) {
                c0 = c5;
                return {from: c2(cX.from), to: c2(cX.to)}
            });
            return c0
        }
        ...
        function bt(c0, c1) {
            aD(B(c0), cX.from, cX.to, function (c2) {
                if (c1 == "end") {
                    return {from: c2, to: c2}
                } else {
                    if (c1 == "start") {
                        return {from: cX.from, to: cX.from}
                    } else {
                        return {from: cX.from, to: c2}
                    }
                }
            })
        }
        ...
        function aD(c3, c5, c4, c0) {
            ...
            var c1 = c0({line: c5.line + c3.length - 1, ch: c2});
            aP(c5, c4, c3, c1.from, c1.to)
        }

        function cP(c4, c3) {
            var c1 = c4.line, c0 = c3.line;
            if (c1 == c0) {
        ...
        function bL() {
            ...
            cj = null;
            var c2 = 0, c0 = Math.min(bb.length, c1.length);
            while (c2 < c0 && bb[c2] == c1[c2]) {
                ++c2
            }
            if (c2 < bb.length) {
                cX.from = {line: cX.from.line, ch: cX.from.ch - (bb.length - c2)}
            } else {
                if (co && ae(cX.from, cX.to)) {
                    cX.to = {line: cX.to.line, ch: Math.min(cG(cX.to.line).text.length, cX.to.ch + (c1.length - c2))}
                }
            }
            bt(c1.slice(c2), "end");
            bb = c1;
        ...
        function aB(c2, c8, c0, c7) {
            ...
            c2 += c5;
            c0 += c5;
            var da = bl.clientHeight, c3 = bl.scrollTop, c1 = false, dc = true;
            if (c8 < c3) {
            ...
            var c9 = bl.clientWidth, db = bl.scrollLeft;
        ...
        function ce(c8, c4) {
            ...
            var c9 = Math.max(c3.from - 100, 0), da = Math.min(cz.size, c3.to + 100);
            if (cR < c9 && c9 - cR < 20) {
                c9 = cR
            }
            if (bM > da && bM - da < 20) {
            ...
            var dc = c8 === true ? [] : b1([{from: cR, to: bM, domStart: 0}], c8);
            var c7 = 0;
        ...
        function b1(c9, c7) {
            for (var c4 = 0, c2 = c7.length || 0; c4 < c2; ++c4) {
                var c6 = c7[c4], c0 = [], c8 = c6.diff || 0;
                for (var c3 = 0, c1 = c9.length; c3 < c1; ++c3) {
                    var c5 = c9[c3];
                    if (c6.to <= c5.from && c6.diff) {
                        c0.push({from: c5.from + c8, to: c5.to + c8, domStart: c5.domStart})
                    } else {
                        if (c6.to <= c5.from || c6.from >= c5.to) {
                            c0.push(c5)
                        } else {
                            if (c6.from > c5.from) {
                                c0.push({from: c5.from, to: c6.from, domStart: c5.domStart})
                            }
                            if (c6.to < c5.to) {
                                c0.push({from: c6.to + c8, to: c5.to + c8, domStart: c5.domStart + (c6.to - c5.from)})
                            }
                        }
                    }
                }
        ...
        function aS(c9, da, dc) {
            ...
            var c6 = dc.shift(), c2 = ar.firstChild, c3 = c9;
        ...
        function aM() {
            ...
            var c1 = ch.offsetHeight, c9 = bl.clientHeight;
            ...
            if (c8 != null) {
                ...
                var c4 = String(cz.size).length, c0 = I(c3), c2 = "";
        ...
        function cW() {
            ...
            var c7 = cX.inverted ? de : c9, c1 = bQ();
            var c0 = al(aE), c2 = al(ar);
                    ...
                    if (/^\s+$/.test(c1.text)) {
                        setTimeout(at(function () {
                            if (c1.parent && /^\s+$/.test(c1.text)) {
                                var c8 = Z(c1);
                                bR("", {line: c8, ch: 0}, {line: c8, ch: c1.text.length})
                            }
                        }, 10))
                    }
                }
        ...
        function bS(c5, c1, c2) {
            function c4(c8) {
                var da = c5.line + c8, c7 = c8 == 1 ? cz.size : -1;
                while (da != c7) {
                    var c6 = cG(da);
                    if (!c6.hidden) {
                        var c9 = c5.ch;
        ...
        function aU(c2) {
            ...
            if (c2.line >= cz.size) {
                return {line: cz.size - 1, ch: cG(cz.size - 1).text.length}
            }
            var c0 = c2.ch, c1 = cG(c2.line).text.length;
            if (c0 == null || c0 > c1) {
                return {line: c2.line, ch: c1}
            } else {
                if (c0 < 0) {
                    return {line: c2.line, ch: 0}
                } else {
                    return c2
                }
            }
        ...
        function cp(c3, c7) {
            var c4 = cX.inverted ? cX.from : cX.to, c8 = c4.line, c0 = c4.ch;
            var c6 = cG(c8);
        ...
        function cy(c0, c1) {
            var c3 = 0, c4 = cS(cX.inverted ? cX.from : cX.to, true);
            if (cw != null) {
                c4.x = cw
            }
            if (c1 == "page") {
        ...
        function bJ(c3) {
            ...
            by({line: c3.line, ch: c2}, {line: c3.line, ch: c0})
        }

        function aL(c0) {
            by({line: c0, ch: 0}, aU({line: c0 + 1, ch: 0}))
        }
        ...
        function bz(c2, c9) {
            ...
            var da = cG(c2), c4 = da.indentation(b2.tabSize), c1 = da.text.match(/^\s*/)[0], c6;
            if (c9 == "prev") {
                if (c2) {
            ...
            bR(c7, {line: c2, ch: 0}, {line: c2, ch: c1.length})
        }
        ...
        function cH(c2, c1) {
            ...
            aC.push({from: 0, to: cz.size})
        }

        function ba(c1) {
            var c0 = b2.tabSize - c1 % b2.tabSize, c3 = aq[c0];
            if (c3) {
                return c3
            }
            ...
            return (aq[c0] = {html: c4 + "</span>", width: c0})
        }
        ...
        cY.prototype.clear = at(function () {
            var c5 = Infinity, c1 = -Infinity;
            for (var c4 = 0, c7 = this.set.length; c4 < c7; ++c4) {
                var c2 = this.set[c4], c0 = c2.marked;
                if (!c0 || !c2.parent) {
                    continue
                }
                var c6 = Z(c2);
        ...
        function bF(c6, c5, c2) {
            ...
            aC.push({from: c6.line, to: c5.line + 1});
            return c0
        }
        ...
        function bW(c0, c2, c1) {
            ...
            c0.gutterMarker = {text: c2, style: c1};
            aT = true;
            return c0
        }
        ...
        function cL(c1, c0) {
            return aY(c1, function (c2, c5) {
                if (c2.hidden != c0) {
                    c2.hidden = c0;
                    a4(c2, c0 ? 0 : 1);
                    var c4 = cX.from.line, c3 = cX.to.line;
                    if (c0 && (c4 == c5 || c3 == c5)) {
                        var c7 = c4 == c5 ? bS({line: c4, ch: 0}, c4, 0) : cX.from;
                        var c6 = c3 == c5 ? bS({line: c3, ch: 0}, c3, 0) : cX.to;
                        if (!c6) {
                            return
                        }
                        bx(c7, c6)
        ...
        function aH(dc, c6) {
            ...
            var c3 = cG(dc), c9 = c3.text;

            function da(dd) {
                return b6(c3, dd).left
            }

            var c7 = 0, c5 = 0, c8 = c9.length, c4;
            ...
            for (; ;) {
                ...
                var db = Math.ceil((c7 + c8) / 2), c0 = da(db);
                if (c0 > c6) {
                    c8 = db;
                    c4 = c0
                } else {
        ...
        function b6(c1, c4) {
            ...
            var c6 = c3.offsetTop, c5 = c3.offsetLeft;
            if (J && c6 == 0 && c5 == 0) {
            ...
            return {top: c6, left: c5}
        }

        function cS(c5, c3) {
            var c0, c1 = bQ(), c4 = c1 * (g(cz, c5.line) - (c3 ? be : 0));
            if (c5.ch == 0) {
                c0 = 0
            } else {
        ...
        function bI(c9, c8) {
            ...
            var c6 = bQ(), c4 = bi(), df = be + Math.floor(c8 / c6);
            var da = Y(cz, df);
            if (da >= cz.size) {
                return {line: cz.size - 1, ch: cG(cz.size - 1).text.length}
            }
            var c1 = cG(da), dc = c1.text;
            var dh = b2.lineWrapping, c7 = dh ? df - g(cz, da) : 0;
            if (c9 <= 0 && c7 == 0) {
                return {line: da, ch: 0}
            }
            function dg(dj) {
            ...
            for (; ;) {
                if (c2 - de <= 1) {
                    return {line: da, ch: (c0 - c9 > c9 - dd) ? de : c2}
                }
                var di = Math.ceil((de + c2) / 2), c3 = dg(di);
                if (c3 > c9) {
                    c2 = di;
                    c0 = c3
                } else {
        ...
        function ap(c2) {
            var c0 = cS(c2, true), c1 = al(bv);
            return {x: c1.left + c0.x, y: c1.top + c0.y, yBot: c1.top + c0.yBot}
        }
        ...
        function cf(c6) {
            var c0 = cX.inverted ? cX.from : cX.to, c8 = cG(c0.line), c1 = c0.ch - 1;
            var c5 = (c1 >= 0 && bq[c8.text.charAt(c1)]) || bq[c8.text.charAt(++c1)];
            if (!c5) {
                return
            }
            var c9 = c5.charAt(0), c7 = c5.charAt(1) == ">", dj = c7 ? 1 : -1, de = c8.styles;
            ...
            var c3 = [c8.text.charAt(c1)], dd = /[(){}[\]]/;

            function db(dx, ds, dt) {
                if (!dx.text) {
                    return
                }
                var dw = dx.styles, dr = c7 ? 0 : dx.text.length - 1, du;
                        ...
                        if (dr >= ds && dr < dt && dd.test(du = dv.charAt(dm))) {
                            ...
                            if (dp.charAt(1) == ">" == c7) {
                                ...
                                if (c3.pop() != dp.charAt(0)) {
                                    return {pos: dr, match: false}
                                } else {
                                    if (!c3.length) {
                                        return {pos: dr, match: true}
                                    }
                                }
                            }
                        }
            ...
            if (!da) {
                da = {pos: null, match: false}
            }
            var dh = da.match ? "CodeMirror-matchingbracket" : "CodeMirror-nonmatchingbracket";
            var df = bF({line: c0.line, ch: c1}, {line: c0.line, ch: c1 + 1}, dh), c2 = da.pos != null && bF({
                    line: dg,
                    ch: da.pos
                }, {line: dg, ch: da.pos + 1}, dh);
            var dc = at(function () {
                df.clear();
                c2 && c2.clear()
            });
        ...
        function cv(c2) {
            var c1 = a8(c2), c0 = c1 && cG(c1 - 1).stateAfter;
            if (!c0) {
                c0 = W(cc)
            } else {
                c0 = p(cc, c0)
        ...
        function bT() {
            ...
            while (ci.length) {
                ...
                var c1 = a8(c3), c0 = c1 && cG(c1 - 1).stateAfter;
                if (c0) {
                    c0 = p(cc, c0)
                } else {
                    c0 = W(cc)
                }
                var c5 = 0, c2 = cc.compareStates, c8 = false, c7 = c1, c4 = false;
    ...
    var M = v.commands = {
        selectAll: function (an) {
            an.setSelection({line: 0, ch: 0}, {line: an.lineCount() - 1})
        }, killLine: function (an) {
            var aq = an.getCursor(true), ap = an.getCursor(false), ao = !ae(aq, ap);
            if (!ao && an.getLine(aq.line).length == aq.ch) {
                an.replaceRange("", aq, {line: aq.line + 1, ch: 0})
            } else {
                an.replaceRange("", aq, ao ? ap : {line: aq.line})
            }
        }, deleteLine: function (an) {
            var ao = an.getCursor().line;
            an.replaceRange("", {line: ao, ch: 0}, {line: ao})
        }, undo: function (an) {
            an.undo()
        }, redo: function (an) {
            an.redo()
            ...
            var ap = an.getCursor(), ao = an.getLine(ap.line);
            if (ap.ch > 0 && ap.ch < ao.length - 1) {
                an.replaceRange(ao.charAt(ap.ch) + ao.charAt(ap.ch - 1), {line: ap.line, ch: ap.ch - 1}, {
                    line: ap.line,
                    ch: ap.ch + 1
                })
            }
    ...
    H.prototype = {
        attach: function (an) {
            ...
            return {line: Z(this.line), ch: this.from}
        }, clear: function () {
            if (this.line) {
    ...
    e.inheritMarks = function (ar, av) {
        var aq = new e(ar), an = av && av.marked;
        if (an) {
            for (var ap = 0; ap < an.length; ++ap) {
                if (an[ap].to == null && an[ap].style) {
                    var ao = aq.marked || (aq.marked = []), au = an[ap];
                    var at = au.dup();
                    ao.push(at);
                    at.attach(aq)
                }
    ...
    e.prototype = {
        replace: function (ar, aq, av) {
            var aw = [], ap = this.marked, at = aq == null ? this.text.length : aq;
            ...
            var au = this.text.length, an = ao.marked, ar = this.marked;
            this.text += ao.text;
            ...
            var an = this.marked, ar = ao.marked;
            if (!an) {
                return
            }
            for (var aq = 0; aq < an.length; ++aq) {
                var au = an[aq], at = au.to == null;
                if (at && ar) {
            ...
            var ax = new b(this.text, au), ay = this.styles, av = 0;
            var ar = false, ap = ay[0], aw;
            ...
            var an = this.text, ar = new b(an);
            while (ar.pos < ap && !ar.eol()) {
                ar.start = ar.pos;
                var ao = at.token(ar, aq)
            }
            return {start: ar.start, end: ar.pos, string: ar.current(), className: ao || null, state: aq}
            ...
            var aG = this.styles, ax = this.text, aD = this.marked;
            var aR = ax.length;
            ...
            if (!ax && an == null) {
                ...
                if (!aD || !aD.length) {
                    for (var aO = 0, az = 0; az < aR; aO += 2) {
                        var aF = aG[aO], aQ = aG[aO + 1], aI = aF.length;
                        if (az + aI > aR) {
                            aF = aF.slice(0, aR - az)
                        }
                        az += aI;
                    ...
                    var av = 0, aO = 0, aB = "", aQ, aU = 0;
                    var aT = aD[0].from || 0, aL = [], aS = 0;
    ...
    i.prototype = {
        chunkSize: function () {
            ...
            for (var aq = 0; aq < this.children.length; ++aq) {
                var an = this.children[aq], av = an.chunkSize();
                if (ap < av) {
                    var ar = Math.min(ao, av - ap), aw = an.height;
                    an.remove(ap, ar, au);
            ...
            for (var ap = 0, ar = this.children.length; ap < ar; ++ap) {
                var an = this.children[ap], au = an.chunkSize();
                if (ao <= au) {
            ...
            for (var ao = 0, ar = this.children.length; ao < ar; ++ao) {
                var au = this.children[ao], aq = au.chunkSize();
                if (an < aq) {
    ...
    function D(an, ar) {
        while (!an.lines) {
            for (var ao = 0; ; ++ao) {
                var aq = an.children[ao], ap = aq.chunkSize();
                if (ar < ap) {
                    an = aq;
                    break
                }
    ...
    function Z(an) {
        ...
        var at = an.parent, ar = r(at.lines, an);
    ...
    function Y(au, ar) {
        ...
        outer:do {
            for (var aq = 0, at = au.children.length; aq < at; ++aq) {
                var ao = au.children[aq], an = ao.height;
                if (ar < an) {
                    au = ao;
                    continue outer
                }
        ...
        for (var aq = 0, at = au.lines.length; aq < at; ++aq) {
            var aw = au.lines[aq], av = aw.height;
            if (ar < av) {
                break
            }
            ar -= av
    ...
    function g(an, au) {
        ...
        outer:do {
            for (var ao = 0, ar = an.children.length; ao < ar; ++ao) {
                var at = an.children[ao], aq = at.chunkSize();
                if (au < aq) {
                    an = at;
                    continue outer
                }
    ...
    k.prototype = {
        addChange: function (an, at, ao) {
            ...
            var ap = +new Date, av = this.done[this.done.length - 1], aw = av && av[av.length - 1];
            var ar = ap - this.time;
            if (this.compound && av && !this.closed) {
                av.push({start: an, added: at, old: ao})
            } else {
                if (ar > 400 || !aw || this.closed || aw.start > an + ao.length || aw.start + aw.added < an) {
                    this.done.push([{start: an, added: at, old: ao}]);
                    this.closed = false
                } else {
                    var au = Math.max(0, aw.start - an), ax = Math.max(0, (an + ao.length) - (aw.start + aw.added));
    ...
    function al(ao, ax) {
        ...
        var aw = 0, av = 0, at = false;
        for (var an = ao; an; an = an.offsetParent) {
            var au = an.offsetLeft, ap = an.offsetTop;
            if (an == aq) {
                aw += Math.abs(au);
                av += Math.abs(ap)
            } else {
...
CodeMirror.defineMode("javascript", function (J, N) {
    ...
    var b = function () {
        function X(aa) {
            return {type: aa, style: "keyword"}
        }

        var U = X("keyword a"), Z = X("keyword b"), Y = X("keyword c");
        var V = X("operator"), W = {type: "atom", style: "atom"};
        return {
            "if": U,
            "while": U,
            "with": U,
                        ...
                        if (U == "/") {
                            ...
                            if (U == "#") {
                                ...
                                if (O.test(U)) {
                                    ...
                                    Y.eatWhile(/[\w\$_]/);
                                    var X = Y.current(), V = b.propertyIsEnumerable(X) && b[X];
    ...
    function m(V) {
        ...
        if (W.context) {
            ...
            W.localVars = {name: V, next: W.localVars}
        }
    }

    var E = {name: "this", next: {name: "arguments"}};
    ...
    return {
        startState: function (U) {
            ...
            var Y = U && U.charAt(0), W = Z.lexical;
            if (W.type == "stat" && Y == "}") {
                W = W.prev
            }
            var X = W.type, V = Y == X;
...
CodeMirror.defineMode("xml", function (z, k) {
    ...
    function i(B, D) {
        ...
        l.context = {prev: l.context, tagName: B, indent: l.indented, startOfLine: D, noIndent: C}
    }
...
CodeMirror.defineMode("markdown", function (C, m) {
    var i = CodeMirror.getMode(C, {name: "xml", htmlMode: true});
    var z = "header", d = "comment", B = "quote", A = "string", F = "hr", t = "link", E = "string", g = "em", j = "strong", x = "emstrong";
    var G = /^([*\-=_])(?:\s*\1){2,}\s*$/, p = /^[*\-+]\s+/, v = /^[0-9]+\.\s+/, n = /^(?:\={3,}|-{3,})$/, f = /^[^\[*_\\<>`]+/;
...
Ext.define("Docs.controller.Examples", {
    ...
    loadExample: function (d, f) {
        ...
        if (!e) {
            this.getController("Failure").show404("Example <b>" + d + "</b> was not found.");
            return
        }
    ...
    loadGuide: function (j, h) {
        ...
        if (this.cache[f]) {
            ...
            Ext.data.JsonP.request({
                ...
                failure: function (b, a) {
                    this.cache[f] = false;
                    this.getController("Failure").show404("Guide <b>" + f + "</b> was not found.")
                },
                scope: this
            })
        }
...
Ext.define("Docs.controller.Videos", {
    ...
    loadVideo: function (j, h) {
        ...
        if (!i) {
            this.getController("Failure").show404("Video <b>" + g + "</b> was not found.");
            return
        }
        this.getViewport().setPageTitle(i.title);
        if (this.activeUrl !== j) {
...
Ext.define("Docs.view.examples.TouchContainer", {
    ...
    initComponent: function () {
        this.dockedItems = [{
            xtype: "container",
            dock: "top",
            html: ['<h1 class="example-title">Example</h1>', '<div class="cls-grouping example-toolbar">', '<div class="devices">', '<button class="phone selected">Phone</button>', '<button class="tablet">Tablet</button>', "</div>", '<span class="separator">&nbsp;</span>', '<div class="orientations">', '<button class="landscape selected">Landscape</button>', '<button class="portrait">Portrait</button>', "</div>", '<span class="separator">&nbsp;</span>', "<div>", '<button class="new-window">Open in new window</button>', "</div>", "</div>"].join("")
        }];
        this.callParent(arguments)
    },
    load: function (b) {
...
Ext.define("Docs.view.cls.PackageLogic", {
    extend: "Docs.view.cls.Logic", create: function () {
        ...
        return {text: this.shortName(b), iconCls: "icon-pkg", leaf: false, children: []}
...
Ext.define("Docs.view.guides.Container", {
    ...
    scrollToEl: function (b) {
        this.scrollToView(b, {highlight: true, offset: -100})
    },
    load: function (b) {
        this.guide = b;
...
Ext.define("Docs.view.videos.Container", {
    ...
    load: function (b) {
        this.video = b;
        this.tpl = this.tpl || new Ext.XTemplate('<object width="640" height="360" id="video_player">', '<param name="allowfullscreen" value="true" />', '<param name="allowscriptaccess" value="always" />', '<param name="flashvars" value="api=1" />', '<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id={id}&amp;server=vimeo.com&amp;color=4CC208&amp;fullscreen=1" />', '<embed src="http://vimeo.com/moogaloop.swf?clip_id={id}&amp;server=vimeo.com&amp;color=4CC208&amp;fullscreen=1" ', 'type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="640" height="360"></embed>', "</object>", "<h1>{title}</h1>", "<p>{[this.linkify(values.description)]}</p>", {
                linkify: function (a) {
...
Ext.define("Docs.view.comments.MemberWrap", {
    ...
    getNewCommentTitle: function () {
        if (this.getDefinedIn() !== this.className) {
            return ["<b>Be aware.</b> This comment will be posted to <b>" + this.getDefinedIn() + "</b> class, ", "from where this member is inherited from."].join("")
        } else {
            return undefined
        }
    },
...
Ext.define("Docs.view.cls.Toolbar", {
    ...
    initComponent: function () {
        ...
        for (var i in h) {
            ...
            if (f.length > 0) {
                var j = this.createMemberButton({text: h[i], type: i, members: f});
